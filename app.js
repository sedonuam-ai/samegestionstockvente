...
let settings = { currency:'€', tva:18, seq:0 };
...
/* =========================================================
   HELPERS AFFICHAGE
========================================================= */
function money(n){ return (isFinite(n)?n:0).toLocaleString('fr-FR',{minimumFractionDigits:2, maximumFractionDigits:2}) + ' ' + settings.currency; }
